...
import { FiUsers, FiSearch, FiFilter, FiPhone, FiMail, FiCalendar, FiDollarSign, FiMapPin, FiShoppingBag } from 'react-icons/fi';
                  ...
                  <div className="flex flex-wrap gap-3 text-xs text-gray-600">
                    ...
                    {user.lastBookingDate && (
                      <div className="flex items-center gap-1">
                        ...
                        <span>Last: {formatDate(user.lastBookingDate)}</span>
                      </div>
                    )}
                  </div>
                </div>
